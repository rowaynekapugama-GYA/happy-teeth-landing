...
def results_pair():
    ...
    photo(im,IMG+'idsafe-flared-before.jpg',(70,392,530,656),r=28)
    photo(im,IMG+'idsafe-flared-after.jpg',(550,392,1010,656),r=28)
    tagpill(im,d,92,414,'BEFORE'); tagpill(im,d,572,414,'AFTER',after=True)
    d=ImageDraw.Draw(im)
    ct(d,W/2,706,'Flared front teeth gently aligned — no braces needed.',inter(31,600),WHITE)
    ct(d,W/2,754,'From $59 per week* with MediPay.',inter(29,500),(200,220,211))
    pill(d,W/2,852,'Book Your FREE Consultation',inter(36,800),WHITE,SALMD)
    disc2(d,952,(150,180,168))
    return im
